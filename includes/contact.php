 ...
 * 
 * För att formattera själva mejlet som skickas, så kan man ändra variablen $mail_template i config.php
...
function is_well_formed_utf8($string)
{
    ...
    // iconv is the fastest and best way to check this but it might not be installed
